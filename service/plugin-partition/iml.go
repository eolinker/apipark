...
func (i *imlPluginService) GetConfig(ctx context.Context, partition string, name string) (*Config, *PluginDefine, error) {
...
func (i *imlPluginService) SetPartition(ctx context.Context, partition string, name string, status plugin_model.Status, config plugin_model.ConfigType) error {
...
func (i *imlPluginService) ListPartition(ctx context.Context, partition string, kind ...plugin_model.Kind) ([]*ConfigPartition, error) {
