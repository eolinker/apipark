...
import (
	...
	"github.com/eolinker/apipark/stores/monitor"
)
...
func (i *imlMonitorService) GetByPartition(ctx context.Context, partitionId string) (*Monitor, error) {
...
func (i *imlMonitorService) MapByPartition(ctx context.Context, partitionIds ...string) (map[string]*Monitor, error) {
