 ...
 * @LastEditTime: 2024-06-07 17:13:07
 * @FilePath: \frontend\packages\common\src\components\aoplatform\dashboard\MonitorTotalPage.tsx
 */
...
import { SummaryPieData, SearchBody, PieData, MonitorApiData, MonitorSubscriberData, InvokeData, MessageData } from "@common/const/dashboard/type";
import { getTime, getTimeUnit, changeNumberUnit } from "@common/utils/dashboard";
...
import DashboardDetail from "@core/pages/dashboard/DashboardDetail";
