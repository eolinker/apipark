...
import {  InvokeData, MonitorApiData, MonitorSubscriberData, SearchBody } from "@common/const/dashboard/type";
...
import { getTime, getTimeUnit } from "@common/utils/dashboard";
import MonitorTable, { MonitorTableHandler } from "./MonitorTable";
import { DashboardDetailInvokeType } from "@core/pages/dashboard/DashboardDetail";
