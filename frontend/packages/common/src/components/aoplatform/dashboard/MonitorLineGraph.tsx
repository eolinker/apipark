 ...
 * @LastEditTime: 2024-06-04 10:27:27
 * @FilePath: \frontend\packages\core\src\components\dashboard\MonitorLineGraph.tsx
 */
import  { FC, useEffect, useMemo, useRef, useState } from 'react';
import ECharts, { EChartsOption } from 'echarts-for-react';
import { InvokeData, LineGraphType, MessageData } from '@common/const/dashboard/type';
import {  MONITOR_LINE_CHART_BASIC_INVOKE_SELECTED, MONITOR_LINE_CHART_BASIC_MESSAGE_SELECTED, MONITOR_LINE_CHART_OPTION_CONFIG, MONITOR_NAME_MAP } from '@common/const/dashboard/const';
import { yUnitFormatter } from '@common/utils/dashboard';
